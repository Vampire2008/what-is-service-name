import type ICulture from "./ICulture";

export default class CompareResults {
    public readonly services: IService[];

    constructor(public readonly leftCulture: ICulture, public readonly rightCulture: ICulture, leftData: IServiceData[], rightData: IServiceData[]) {
